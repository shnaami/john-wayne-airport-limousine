...
export default function sitemap():MetadataRoute.Sitemap{
  return [
    ...
    ...ROUTES.map(r=>({url:`${SITE_URL}/routes/${r.slug}`,lastModified:["newport-beach","irvine","dana-point","san-clemente"].includes(r.slug)?new Date("2026-09-24"):undefined,changeFrequency:"monthly" as const,priority:r.county==="Orange County"?.86:.72}))
  ];
}
